...
/// </summary>
public partial class DirectMessagesChatTopicCanUnpaidMessagesClient : BaseClient
{
    /// <summary>
    /// Allows to send unpaid messages to the given topic of the channel direct messages chat administered by the current user
    /// </summary>
...
public partial interface IDirectMessagesChatTopicCanUnpaidMessagesClient
{
    /// <summary>
    /// Allows to send unpaid messages to the given topic of the channel direct messages chat administered by the current user
    /// </summary>
