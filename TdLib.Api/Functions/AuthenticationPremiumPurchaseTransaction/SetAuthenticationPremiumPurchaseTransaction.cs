...
/// </summary>
public partial class AuthenticationPremiumPurchaseTransactionClient : BaseClient
{
    /// <summary>
    /// Informs server about an in-store purchase of Telegram Premium before authorization. Works only when the current authorization state is authorizationStateWaitPremiumPurchase
    /// </summary>
...
public partial interface IAuthenticationPremiumPurchaseTransactionClient
{
    /// <summary>
    /// Informs server about an in-store purchase of Telegram Premium before authorization. Works only when the current authorization state is authorizationStateWaitPremiumPurchase
    /// </summary>
